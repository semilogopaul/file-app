...
export function EmptyFolderIllustration({ className }: SpotProps) {
  return (
    <svg {...svgProps} className={className}>
      <ellipse cx="100" cy="132" rx="66" ry="14" className="fill-brand-100" />
      {/* Back panel */}
      <path
...
export function NoResultsIllustration({ className }: SpotProps) {
  return (
    <svg {...svgProps} className={className}>
      <ellipse cx="100" cy="134" rx="58" ry="12" className="fill-brand-100" />
      <g transform="translate(46 26)">
        <circle
          ...
          strokeWidth="2"
        />
        <circle cx="44" cy="44" r="28" className="fill-brand-50" />
...
export function UploadIllustration({ className }: SpotProps) {
  return (
    <svg {...svgProps} className={className}>
      <ellipse cx="100" cy="136" rx="62" ry="12" className="fill-brand-100" />
      <path
...
export function BrokenLinkIllustration({ className }: SpotProps) {
  return (
    <svg {...svgProps} className={className}>
      <ellipse cx="100" cy="132" rx="60" ry="12" className="fill-brand-100" />
      <g
